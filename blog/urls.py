...
urlpatterns = [
    ...
    path("settings/account/", views.SettingsAccount.as_view(), name="settings-account"),
    path("settings/notifications/", views.SettingsNotify.as_view(), name="settings-notify"),
